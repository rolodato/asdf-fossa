...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for fossa.
GH_REPO="https://github.com/fossas/fossa-cli"
TOOL_NAME="fossa"
TOOL_TEST="fossa --version"
...
# NOTE: You might want to remove this if fossa is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if fossa has other means of determining installable versions.
  list_github_tags
}
...
install_version() {
  ...
  (
    ...
    chmod +x "$install_path/bin/$tool_cmd" || fail "Expected $install_path/bin/$tool_cmd to be executable."
